...
from HtmlTestRunner.runner import UTF8
...
from tests.screens_sample.screen_event_object import screen_event_button_test, screen_event_button_list_test, screen_event_number_test, screen_event_number_auto_test,screen_event_checkbox_test,screen_event_date_test,screen_event_group_test,screen_event_checkbox_list_test, screen_event_field_value_test
from tests.customer.dev.screen_basic_test import screen_event_label_test,screen_event_radio_test,screen_event_image_test

from tests.customer.rel import dashboard_rel_test
...
from tests.customer.dev.screen_basic_test import screen_event_selection_test,screen_event_video_test, screen_search_text_test, screen_search_number_test, screen_event_label_test, screen_event_text_test, screen_event_radio_test, screen_event_selection_test, screen_event_attachment_test, screen_event_video_test, screen_event_image_test, screen_event_link_test, screen_event_search_date_test
...
HtmlTestRunner.HTMLTestRunner(combine_reports=True, report_name="MyReport",open_in_browser=True, add_timestamp=False).run(all_suites())
